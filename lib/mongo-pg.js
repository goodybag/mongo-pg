...
module.exports.registerConditionalHelper = function(name, options, fn){
  QueryBuilder.helpers.conditional.add(name, options, fn);
};

module.exports.registerHelper = function(name, options, fn){
  QueryBuilder.helpers.value.add(name, options, fn);
};
